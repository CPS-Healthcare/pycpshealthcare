...
def test_study_ocurrence_import():
    try:
        from pycpshealthcare.db.SanPedro.participant_study import SanPedroStudyOcurrence
    except ImportError:
        pytest.fail("Failed to import")
...
def test_participant_study_group_import():
    try:
        from pycpshealthcare.db.SanPedro.participant_study import ParticipantSanPedroStudiesGroup
    except ImportError:
        pytest.fail("Failed to import")
