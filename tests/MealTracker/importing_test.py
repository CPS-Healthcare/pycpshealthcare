...
def test_study_ocurrence_import():
    try:
        from pycpshealthcare.db.MealTracker.participant_study import MealTrackerStudyOcurrence
    except ImportError:
        pytest.fail("Failed to import")
...
def test_participant_study_group_import():
    try:
        from pycpshealthcare.db.MealTracker.participant_study import ParticipantMealTrackerStudiesGroup
    except ImportError:
        pytest.fail("Failed to import")
