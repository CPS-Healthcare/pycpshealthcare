...
def test_study_ocurrence_import():
    try:
        from pycpshealthcare.db.Marcoleta.participant_study import MarcoletaStudyOcurrence
    except ImportError:
        pytest.fail("Failed to import")
...
def test_participant_study_group_import():
    try:
        from pycpshealthcare.db.Marcoleta.participant_study import ParticipantMarcoletaStudiesGroup
    except ImportError:
        pytest.fail("Failed to import")
