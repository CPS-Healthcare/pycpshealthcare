    ...
    def _generate_studies_object(self):
        for study_type, study_raw in self.studies_raw.items():
            if study_type == "Pancreas":
                ...
                self.studies_groups["Pancreas"] = ParticipantPancreasStudiesGroup(
                    self.studies["Pancreas"], self.connection
                )
                ...
                self.studies_groups["MealTracker"] = ParticipantMealTrackerStudiesGroup(
                    self.studies["MealTracker"], self.connection
                )
                ...
                self.studies_groups["SanPedro"] = ParticipantSanPedroStudiesGroup(
                    self.studies["SanPedro"], self.connection
                )
                ...
                self.studies_groups["Marcoleta"] = ParticipantMarcoletaStudiesGroup(
                    self.studies["Marcoleta"], self.connection
                )
                ...
                self.studies_groups["ChronoNevado"] = ParticipantChronoNevadoStudiesGroup(
                    self.studies["ChronoNevado"], self.connection
                )
                ...
                self.studies_groups["Chronotype"] = ParticipantChronotypeStudiesGroup(
                    self.studies["Chronotype"], self.connection
                )
